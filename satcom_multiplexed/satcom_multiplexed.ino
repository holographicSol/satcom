...
void setup() {
  ...
  satData.location_range_distance_latitude[1] = satData.latitude_meter*40074274.94;  // specify latitude range
  satData.location_range_distance_longitude[1] = satData.longitude_meter*40074274.94; // specify longitude range

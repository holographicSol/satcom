...
void loop() {
  ...
  in order to decide what data to use for the next decision. this check is here crudely for now and can be a part of the 'brain' later.
  */
